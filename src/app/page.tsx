      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-16 text-center md:py-24">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg text-muted-foreground md:text-xl">
            A curated collection of my projects, from interactive games and modern websites to stunning 3D generations. Explore, interact, and get in touch.
          </p>
        </section>

        <CreativeShowcase initialProjects={projects} />
